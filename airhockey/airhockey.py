...
#Imported required modules and libraries.

def run(): 
    pygame.init()
    clock = pygame.time.Clock()
    WHITE = (255,255,255) #Defining the colours in terms of RGB values.
    BLUE = (56,142,142)
    black = (0,0,0)
    ...
    # A class to draw the background
    ...
    while game_run is True :
        ...
        if Check_collision(puck,paddle1) :
            #Changes the direction of the puck.
            puck.dx = -1 * puck.dx 
            puck.dy = -1 * puck.dy 
